...
10.times do
    ...
    category = "通識-社會科學"
    semester = "103-2"
    comment = "上課內容wdawdawd很紮實，老師口wdawda條滿清楚的，認真聽可以學到很多營養學相關知awdawdawd識，還有一些日常生活中的飲食迷思
你覺得你在這堂課付出多少：8/10
你覺得你在這堂課收穫多少：8/10
你覺得你在這堂課付出與收穫的關係如何：undefined"
    detail = "無awdawdawdawdawdawdawdawdawdawdawdawdad"
    exam = "期中考試都考PawdawdPT內容及上課特別提醒的重點，並不難作業方式：
期末書面報告內容包括口頭報告的延伸整理(3頁)及2位同學報告的內容補充(2頁)，不得超過5頁word報告方式：
4-5位，報告內容為餐盒評析，awdawda針對三個便當餐盒評析其營養價值及優缺點，報告時間為5分鐘。
期末個人口頭報告的題目wdawdawdwada自訂，與食品營養相關，報告時間為5分鐘，報告完需繳交期末書面報告電子檔點名方式：
